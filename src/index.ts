...
var imgs = a1lib.ImageDetect.webpackImages({
	contracttop: require("./detect/contracttop.data.png"),
	redX: require("./detect/redX.data.png"),
	greenTick: require("./detect/greenTick.data.png"),
	draynor: require("./detect/draynor.data.png"),
	draynor_legacy: require("./detect/draynor_legacy.data.png"),
	complete: require("./detect/complete.data.png"),
...
const src_imgs = {
	...
	"Mahogany plank": require("./imgs/Mahogany plank.png"),
	"Protean plank": require("./imgs/Protean plank.png"),
	"Bronze nails": require("./imgs/Bronze nails.png"),
	"Iron nails": require("./imgs/Iron nails.png"),
	"Steel nails": require("./imgs/Steel nails.png"),
	"Black nails": require("./imgs/Black nails.png"),
	"Mithril nails": require("./imgs/Mithril nails.png"),
	"Adamant nails": require("./imgs/Adamant nails.png"),
	"Rune nails": require("./imgs/Rune nails.png"),
	"White candle":  require("./imgs/White candle.png"),
	"Bolt of cloth": require("./imgs/Bolt of cloth.png"),
	"Iron bar": require("./imgs/Iron bar.png"),
	"Steel bar": require("./imgs/Steel bar.png"),
	"Mithril bar": require("./imgs/Mithril bar.png"),
	"Adamant bar": require("./imgs/Adamant bar.png"),

	"Edgeville General Store": require("./imgs/Edgeville General Store.png"),
	"Lumbridge General Store": require("./imgs/Lumbridge General Store.png"),
	"Bob": require("./imgs/Bob.png"),
	"Victoria": require("./imgs/Victoria.png"),
	"Father Aereck": require("./imgs/Father Aereck.png"),
	"Charos": require("./imgs/Charos.png"),
	"Blue Moon Inn": require("./imgs/Blue Moon Inn.png"),
	"Varrock General Store": require("./imgs/Varrock General Store.png"),
	"Wise Old Man": require("./imgs/Wise Old Man.png"),
	"Aggie": require("./imgs/Aggie.png"),
